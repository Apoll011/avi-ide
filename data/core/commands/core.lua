...
command.add(nil, {
  ...
  ["core:open-project-module"] = function()
    if not system.get_file_info(".avi_studio_project.lua") then
      core.try(core.write_init_project_module, ".avi_studio_project.lua")
    end
    local doc = core.open_doc(".avi_studio_project.lua")
