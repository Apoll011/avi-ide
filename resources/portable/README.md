...
* `$XDG_CONFIG_HOME/avi-studio` - Linux or any OS that follows the XDG specification
* `$HOME/.config/avi-studio` - Any Unix based system (macOS, FreeBSD, etc...)
* `$USERPROFILE/.config/avi-studio` - Windows
